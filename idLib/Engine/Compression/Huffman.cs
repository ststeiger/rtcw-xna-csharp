...
namespace idLib.Engine.Compression.Huffman
{
    /// <summary>
    ///     Author: Eric Nusbaum
    ...
    ///     Date: 05/22/2009
    /// </summary>
    public class idHuffman : IDisposable
    {
        #region --[ Members ]--
        /*
...
// jv
        public idHuffman(MemoryStream stream)
        {
            Init();

            byte[] bInput = stream.ToArray();
...
// end
        public idHuffman(string sInput)
        {
            Init();
