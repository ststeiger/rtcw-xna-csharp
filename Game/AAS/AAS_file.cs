...
namespace Game.AAS
{
    ...
    */
    ...
    class idAASFile
    {
        ...
        // ParseAASFile
        //
        public void ParseAASFile(ref idFile file)
        {
    ...
    //bounding box
    struct aas_bbox_t : aas_lumpinterface_t
    {
    ...
    struct aas_reachability_t : aas_lumpinterface_t
    {
	    ...
	    public ushort traveltime; //travel time of the inter area movement

        public const int Size = (sizeof(int) * 4) + sizeof(ushort) + (idVector3.Size * 2);
        ...
        public void InitFromFile(ref idFile file)
        {
            ...
            traveltime = file.ReadUShort();
        }
    };

    //area settings
    struct aas_areasettings_t : aas_lumpinterface_t
    {
    ...
    //cluster portal
    struct aas_portal_t : aas_lumpinterface_t
    {
    ...
    //cluster
    struct aas_cluster_t : aas_lumpinterface_t
    {
    ...
    struct  aas_plane_t : aas_lumpinterface_t
    {
    ...
    //edge
    struct aas_edge_t : aas_lumpinterface_t
    {
    ...
    struct aas_face_t : aas_lumpinterface_t
    {
    ...
    struct aas_area_t : aas_lumpinterface_t
    {
    ...
    //nodes of the bsp tree
    struct aas_node_t : aas_lumpinterface_t
    {
